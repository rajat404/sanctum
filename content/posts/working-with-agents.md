...
The LLM/Agentic-space appears to move at light speed. Keeping up seems like a losing battle, nevertheless I can't help but try :)

Inspired from https://simonwillison.net/guides/agentic-engineering-patterns/ (which I highly recommend reading), this is the place I'll keep updating with the agentic patterns, techniques and tools I use.
